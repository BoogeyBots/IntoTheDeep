...
public class FollowerConstants {
    ...
    private static double xMovement = 117.2721;
    private static double yMovement = 88.296;
    ...
    public static double mass = 12.85;
    ...
    public static double forwardZeroPowerAcceleration = -59.605;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -124.3357;
