...
@Config
@Autonomous (name = "Basket nou")
public class Basket_nou extends OpMode {
    ...
    public static double timer1 = 1.6, timer2 = 1.9, timer3 = 1.55, timer4 = 0.28;
    ...
    public static double x_submersible = 61, y_submersible = 96, heading_submersible = 90;
    ...
    Pose submersible2 = new Pose(x_submersible + 3, y_submersible, heading_submersible);
    Pose submersible3 = new Pose(x_submersible + 6, y_submersible, heading_submersible);
    Pose control1 = new Pose(x_control1, y_control1);


    private Path scorePreload, rotire;
    private PathChain score, move1, move2, move3, move4, move5, move6, move7, move8, move7_1, move7_2, move8_2, move9, move10, move11, move12, move13, move14, move15, moving_submersible, moving_submersible_reverse, miscare_intermediara;
    public void buildPaths() {
        ...
        move5 = follower.pathBuilder()
                ...
                .setConstantHeadingInterpolation(Math.toRadians(heading_colectare3))
                .build();
        ...
        move7_1 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(preload), new Point(control1), new Point(submersible2)))
                .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(90))
                .build();

        move7_2 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(preload), new Point(control1), new Point(submersible3)))
                .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(90))
                .build();
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 22:
                ...
                if(pathTimer.getElapsedTimeSeconds() > timer2 + 0.2) {
                    extendo.extinde();
                    setPathState(23);
                }
            ...
            case 23:
                if(pathTimer.getElapsedTimeSeconds() > 0.01 && sensor.getDistance(DistanceUnit.CM) < 1) {
            ...
            case 44:
                if(pathTimer.getElapsedTimeSeconds() > timer1 + 0.1) {
                    extendo.mediu();
                }
                ...
                if(pathTimer.getElapsedTimeSeconds() > timer2 + 0.3) {
                    extendo.extinde();
                    setPathState(46);
                }
