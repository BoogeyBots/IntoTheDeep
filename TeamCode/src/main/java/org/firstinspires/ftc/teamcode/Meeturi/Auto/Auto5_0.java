...
public class Auto5_0 extends OpMode {
    ...
    public static double x_colectare1 = 14, y_colectare = 28, heading_colectare = 0;
    public static double x_colectare2 = 16;
    public static double x_colectare3 = 18;
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 14:
                if(actionTimer.getElapsedTimeSeconds() > timer3) {
